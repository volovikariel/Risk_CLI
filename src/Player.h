...
public:
    ...
    Player();
    Player(vector<Territory*> playerTerritories_, Hand* playerCards_, OrdersList* playerOrderList_, int playerArmies_, int playerID_);
    ...
    void setPlayerOrders(Order* playerOrderList_);
